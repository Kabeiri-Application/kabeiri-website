        ...
        <div className="mb-8 space-y-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-200 bg-white py-3 pr-4 pl-12 text-base placeholder:text-gray-500 focus:border-purple-500 focus:ring-2 focus:ring-purple-500 focus:outline-hidden"
            />
          </div>
          ...
          <div className="flex gap-4">
            ...
            <select className="rounded-lg border border-gray-200 bg-white px-4 py-2 text-base focus:border-purple-500 focus:ring-2 focus:ring-purple-500 focus:outline-hidden">

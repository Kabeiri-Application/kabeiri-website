    ...
    <main className="p-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          {/* Recent Jobs */}
          <div className="rounded-2xl bg-white dark:bg-gray-800 p-6 shadow-xs">
            <h2 className="mb-4 text-lg font-bold dark:text-white">Recent Jobs</h2>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium dark:text-white">Oil Change - Toyota Camry</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300">2 hours ago</p>
                </div>
              </div>
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium dark:text-white">Brake Replacement - Ford F-150</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300">2 hours ago</p>
                </div>
              </div>
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium dark:text-white">Tire Rotation - Honda Civic</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300">2 hours ago</p>
                </div>
              </div>
            </div>
          ...
          {/* Low Inventory Alert */}
          <div className="rounded-2xl bg-white dark:bg-gray-800 p-6 shadow-xs">
            <h2 className="mb-4 text-lg font-bold dark:text-white">Low Inventory Alert</h2>
            <div className="space-y-4">
              <div className="flex items-center justify-between">

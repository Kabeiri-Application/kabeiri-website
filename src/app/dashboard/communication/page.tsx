        ...
        <div className="mb-8 grid gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-2xl bg-white p-6 shadow-xs">
            ...
            <form className="space-y-4">
              <div>
                <input
                  className="w-full rounded-lg border border-gray-200 bg-white px-4 py-3 text-base placeholder:text-gray-500 focus:border-purple-500 focus:ring-2 focus:ring-purple-500 focus:outline-hidden"
                  type="email"

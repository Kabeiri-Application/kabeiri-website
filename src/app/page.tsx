        ...
        <div className='mx-auto max-w-7xl px-6'>
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-20'>
            <div className='space-y-4'>
              ...
              <h3 className='text-xl font-semibold'>AI-Powered Diagnostics</h3>
              <p className='text-gray-600'>
                Advanced real-time diagnostics and predictive maintenance
                powered by our proprietary AI technology and OBD integration.
              </p>
            </div>
            ...
            <div className='space-y-4'>
              ...
              <h3 className='text-xl font-semibold'>Digital Workflows</h3>
              <p className='text-gray-600'>
                Streamlined operations for mechanics and workshops with smart
                scheduling, digital documentation, and automated reporting.
              </p>
            </div>
            ...
            <div className='space-y-4'>
              ...
              <h3 className='text-xl font-semibold'>Open APIs</h3>
              <p className='text-gray-600'>
                Build innovative solutions with our comprehensive API suite,
            ...
            <div className='space-y-4'>
              ...
              <p className='text-gray-600'>
                Access a thriving ecosystem of third-party apps, services, and
                automotive solutions all in one place.
              </p>
            </div>
            ...
            <div className='space-y-4'>
              ...
              <h3 className='text-xl font-semibold'>Multi-User Access</h3>
              <p className='text-gray-600'>
                Collaborate seamlessly between car owners, mechanics, and
                service providers with role-based access control.
              </p>
            </div>
            ...
            <div className='space-y-4'>
              ...
              <p className='text-gray-600'>
                Bank-grade security protocols and compliance measures to protect
                your sensitive automotive data.
              </p>
            </div>
          </div>
        </div>

          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-xs focus:border-purple-500 focus:ring-2 focus:ring-purple-500 focus:outline-hidden"
              />
            </div>
